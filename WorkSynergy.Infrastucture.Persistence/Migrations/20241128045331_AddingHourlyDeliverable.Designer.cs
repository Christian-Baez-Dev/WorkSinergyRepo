...
namespace WorkSynergy.Infrastucture.Persistence.Migrations
{
    ...
    [Migration("20241128045331_AddingHourlyDeliverable")]
    partial class AddingHourlyDeliverable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkSynergy.Core.Domain.Models.HourlyMilestoneDeliverable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HourlyMilestoneId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HourlyMilestoneId");

                    b.ToTable("Hourly_Milestone_Deliverables", (string)null);
                });
            ...
            modelBuilder.Entity("WorkSynergy.Core.Domain.Models.HourlyMilestoneDeliverable", b =>
                {
                    b.HasOne("WorkSynergy.Core.Domain.Models.HourlyMilestone", "HourlyMilestone")
                        .WithMany("Deliverables")
                        .HasForeignKey("HourlyMilestoneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HourlyMilestone");
                });
